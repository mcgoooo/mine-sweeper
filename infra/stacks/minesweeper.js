...
class MinesweeperSiteStack extends cdk.Stack {
  constructor(parent, name, props) {
    ...
    this.certificate = GetCertFromArn(this, `${this.stackUri}-subdomain-cert`, props.certificateArn)

    this.setCluster()
    this.nextSite = new NextSiteFromLocalDockerFile(this, `${this.stackUri}-next`);
  }
